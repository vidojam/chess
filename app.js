    ...
    switch (piece) {
        ...
        case 'bishop':
            if (
                ...
                startId + width * 4 + 4 && !document.querySelector(`[square-id]= "${startId + width + 1}"]`).firstChild && !document.querySelector(`[square-id]= "${startId + width * 2 + 2}"]`).firstChild && !document.querySelector(`[square-id]= "${startId + width * 3 + 3}"]`).firstChild && !document.querySelector(`[square-id]= "${startId + width * 4 + 4}"]`).firstChild ||
                startId + width * 5 + 5 && !document.querySelector(`[square-id]= "${startId + width + 1}"]`).firstChild && !document.querySelector(`[square-id]= "${startId + width * 2 + 2}"]`).firstChild && !document.querySelector(`[square-id]= "${startId + width * 3 + 3}"]`).firstChild && !document.querySelector(`[square-id]= "${startId + width * 4 + 4}"]`).firstChild && !document.querySelector(`[square-id]= "${startId + width * 5 + 5}"]`).firstChild ||
